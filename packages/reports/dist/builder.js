 ...
 */
export async function buildReport(prisma, scheduledReport) {
...
export function formatReportText(data) {
    ...
    const currency = 'BRL';
    const formatMoney = (v) => v.toLocaleString('pt-BR', { style: 'currency', currency });
 ...
 */
function resolveDateRange(frequency) {
